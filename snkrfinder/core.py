...
__all__ = ['get_home', 'get_root', 'HOME', 'ROOT', 'dump_pickle', 'load_pickle', 'add_time_stamp', 'L_ROOT', 'D_ROOT',
           'DBS', 'ZAPPOS_META_DIR', 'SCRAPED_META_DIR', 'SCRAPED_DF', 'COMBINED_SNEAKERS_DF', 'COMBINED_DF',
           'QUERY_IM', 'QUERY_IM2', 'IMG_SIZE_LG', 'IMG_SIZE_MD', 'IMG_SIZE_SM', 'IMG_SIZE', 'IMG_SIZES', 'IMSZ2LAB',
           'SIZE_ABBR', 'ZAPPOS_DF_SIMPLIFIED', 'ZAPPOS_FEATS_ALL', 'ZAPPOS_FEATS_ALL_SORT', 'ZAPPOS_FEATS_SM',
           'ZAPPOS_FEATS_MD', 'ZAPPOS_FEATS_LG', 'BETA', 'LATENT_DIM', 'mobilenet_v2_meta', 'IM_STATS', 'DEFAULT_STATS',
