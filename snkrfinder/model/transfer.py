...
__all__ = ['transfer_mobilenet_v2', 'zap_get_x', 'zap_get_y', 'get_zappos_datablock', 'prep_df_for_datablocks',
           'get_zappos_cat_dataloaders']
...
def zap_get_y(r): return r['Category']  # we aren't actually using the category here (see 02_model.ipynb)
