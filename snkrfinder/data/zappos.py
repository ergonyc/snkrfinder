# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/01a_data.zappos.ipynb (unless otherwise specified).

__all__ = ['get_zappos_db', 'read_zappos_meta', 'simplify_zappos_db', 'skl_tt_split', 'add_subdir',
           'creat_full_local_categorydirs', 'create_test_train_directories']
...
def creat_full_local_categorydirs(df,lpath):
    # create full set
    print('_'*30)
...
def create_test_train_directories(df,lpath):
